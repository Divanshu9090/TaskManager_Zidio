      ...
      <div className="w-full md:w-auto flex gap-0 md:gap-40 flex-col md:flex-row items-center justify-center">
        ...
        <div className="h-full w-full lg:w-2/3 flex flex-col items-center justify-center">
          <div className="w-full md:max-w-lg 2xl:max-w-3xl flex flex-col items-center justify-center gap-5 md:gap-y-10 2xl:-mt-20">
            ...
            <p className="flex flex-col gap-0 md:gap-4 text-4xl md:text-6xl 2xl:text-7xl font-extrabold text-center text-green-500">
              <span>
                <img
            ...
            <div className="flex flex-col gap-y-5">
              ...
              {isLoading ? (
                ...
                <Button
                  type="submit"
                  label="Submit"
                  className="w-full h-12 bg-green-500 text-white rounded-full text-lg font-semibold hover:bg-green-800 transition duration-300"
                />
              )}
            </div>
          </form>
